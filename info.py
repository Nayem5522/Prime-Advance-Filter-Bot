...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/Prime_Movie_Watch_Dawnload")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Prime_Nayem') # owner username without @
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+zPYOB8biBP84MmU1') # Support Chat Link Without https:// or @
