...
PICS = (environ.get('PICS', 'https://graph.org/file/cde15afa6f17d313282f8.jpg')).split() #SAMPLE PIC
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002215951578')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+OzcPK0fNNew5Yjk1')
